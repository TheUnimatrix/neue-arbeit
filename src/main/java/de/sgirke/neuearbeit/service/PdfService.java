...
public interface PdfService {
	...
	/**
	 * Name des Context-Parameters, welcher den relativen Pfad zur XSL-Datei zum Generieren des PDF-Dokuments für
	 * den unbestimmten Zeitraum enthält
	 */
	String CONTEXT_PARAM_XSL_YEARS_PDF_FILE = "de.sgirke.neuearbeit.XSL_YEARS_PDF_FILE";
	
	/**
	 * Name des Context-Parameters, welcher den relativen Pfad zur XSL-Datei zum Generieren des PDF-Dokuments für
	 * den spezifischen Zeitraum enthält
	 */
	String CONTEXT_PARAM_XSL_DATES_PDF_FILE = "de.sgirke.neuearbeit.XSL_DATES_PDF_FILE";
	
	/**
	 * Methode zum Generien eines PDF-Streams aus einer XML mit den Angaben zu Arbeitszeiten sowie einer XSL-Datei
	 ...
	 * @param xmlWorkingDays String-Repräsentation einer XML mit allen Angaben zu den Arbeitszeiten zu dem gewählten Zeitraum in Jahren
	 ...
	 * @param xmlWorkingDays String-Repräsentation einer XML mit allen Angaben zu den Arbeitszeiten zu dem gewählten Zeitraum mit Datumsangaben
	 * @return Stream mit allen relevanten Daten für ein PDF-Dokument
	 * @throws FOPException Exception, die beim Generieren des PDF-Dokuments auftreten kann
	 * @throws TransformerException Exception, die beim Generieren des PDF-Dokuments auftreten kann
	 */
