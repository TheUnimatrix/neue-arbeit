...
/**
 * Service-Klasse zum Validieren benutzerspezifischer Eingaben aus einem Formular.
...
public interface ValidationService {
	 ...
	 * @param errorList Liste mit Fehlermeldungen, die bei der Validierung auftreten können
	 */
	void validateYears(int startYear, int endYear, List<String> errorList);
	
	/**
	 * Methode zum Validieren von benutzerspezifischen Datumsangaben aus einem bestimmten Zeitraum.
	 * @param startDate Anfangsdatum des gewählten Zeitraums
	 * @param endDate Enddatum des gewählten Zeitraums
	 * @param errorList Liste mit Fehlermeldungen, die bei der Validierung auftreten können
	 */
	void validateDates(String startDate, String endDate, List<String> errorList);
